...
public class ImageUtil {
	...
	public static void main(String[] args) throws IOException {
		Thumbnails.of(new File("C:/Users/Gorgeous/Desktop/win.jpg")).size(200, 200)
				.watermark(Positions.BOTTOM_RIGHT,
						ImageIO.read(new File("C:/homeproject/o2o/src/main/resources/watermake.jpg")), 0.25f)
				.outputQuality(0.8f).toFile("C:/Users/Gorgeous/Desktop/winnew.jpg");
		;
	}
	...
	public static String generateNormalImgs(ImageHolder thumbnail, String targetAddr) {
		...
		System.out.println(FileUtil.getImgBasePath() + relativeAddr);
		logger.debug("current relativeAddr is"+relativeAddr);
		//获取文件要保存的路径
				try {
